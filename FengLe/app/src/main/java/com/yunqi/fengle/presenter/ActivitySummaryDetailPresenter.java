...
import com.yunqi.fengle.presenter.contract.ActivitySummaryDetailContract;
...
public class ActivitySummaryDetailPresenter extends RxPresenter<ActivitySummaryDetailContract.View> implements ActivitySummaryDetailContract.Presenter {

    private RetrofitHelper mRetrofitHelper;

    @Inject
    public ActivitySummaryDetailPresenter(RetrofitHelper retrofitHelper) {
