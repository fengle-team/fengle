 ...
 * 发货申请
 */
public class DeliveryRequestActivity extends BaseActivity<DeliveryQueryPresenter> implements DeliveryRequestContract.View, RadioGroup.OnCheckedChangeListener {


    public static final int ADD_REQUEST_CODE = 1;
    public static final int SELECT_CUSTOMER_REQUEST_CODE = 2;
    ...
    protected void initEventAndData() {
        ...
        setToolBar(toolbar, getString(R.string.module_delivery_request));
    ...
    private void setWidgetListener() {
        tableViewEx.tableView.addDataClickListener(new TableDataClickListener<InvoiceApply>() {
            @Override
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (lstartTime > 0 && lendTime > 0 && lstartTime >= lendTime) {
                            ToastUtil.showNoticeToast(DeliveryRequestActivity.this, getString(R.string.warming_time_select));
                            return;
                        }
        ...
        RxView.clicks(btnStartTime)
                ...
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        TimeSelectDialog dialog = new TimeSelectDialog(DeliveryRequestActivity.this, new TimeSelectDialog.TimeSelectListener() {
                            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADD_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            mlistInvoiceApply.remove(position);
