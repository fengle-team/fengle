...
import com.yunqi.fengle.presenter.AddBillingPresenter;
 ...
 * 添加开票申请
 */
public class AddBillingRequestActivity extends BaseActivity<AddBillingPresenter> implements AddBillingContract.View {
    ...
    protected void initEventAndData() {
        ...
        setToolBar(toolbar, getString(R.string.module_add_billing_request), getString(R.string.operater), new View.OnClickListener() {
            @Override
    ...
    private void setWidgetListener() {
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if(goodsArray.size()>0){
                            DialogHelper.showDialog(AddBillingRequestActivity.this, getString(R.string.warimg_selected_goods_clear), new SimpleDialogFragment.OnSimpleDialogListener() {
                                @Override
                                public void onOk() {
                                    goodsArray.clear();
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if(selectCustomer==null){
                            ToastUtil.showNoticeToast(AddBillingRequestActivity.this,getString(R.string.warimg_unselect_customer));
                            return;
                        }
        ...
        tableView.addDataClickListener(new TableDataClickListener<GoodsAndWarehouse>() {
            ...
            public void onDataClicked(final int rowIndex, GoodsAndWarehouse goodsAndWarehouse) {
                DialogHelper.showDialog(AddBillingRequestActivity.this, "确定删除?", new SimpleDialogFragment.OnSimpleDialogListener() {
                    @Override
                    public void onOk() {
