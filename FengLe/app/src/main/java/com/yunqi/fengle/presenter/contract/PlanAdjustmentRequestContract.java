...
public interface PlanAdjustmentRequestContract {
    ...
    interface Presenter extends BasePresenter<PlanAdjustmentRequestContract.View> {
         ...
         * @return
         */
        void queryPlanAdjustmentApply(String userid,String area_code,String from_area_code,String to_area_code, int status, String startTime, String endTime, final int page);
    }
}
