...
import com.yunqi.fengle.presenter.ActivitySummaryDetailPresenter;
...
public class ActivitySummaryDetailActivity extends BaseActivity<ActivitySummaryDetailPresenter> implements GridImageAdapter.OnAddPicClickListener {

    public static final String TAG_INFO = "tagInfo";
    private ActivityAddResponse planBean;
    ...
    private void initView() {
        etClientName.setText(planBean.getClient_name());
    ...
    private boolean getData() {
        if (!getIntent().hasExtra(TAG_INFO)) {
            return false;
        }
        planBean = (ActivityAddResponse) getIntent().getSerializableExtra(TAG_INFO);
        return true;
    }
