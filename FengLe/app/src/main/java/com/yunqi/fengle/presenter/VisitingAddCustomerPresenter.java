...
public class VisitingAddCustomerPresenter extends RxPresenter<VisitingAddCustomerContract.View> implements VisitingAddCustomerContract.Presenter{

    private RetrofitHelper mRetrofitHelper;

    @Inject
    public VisitingAddCustomerPresenter(RetrofitHelper retrofitHelper) {
