...
public interface PaymentQueryContract {
    ...
    interface Presenter extends BasePresenter<PaymentQueryContract.View> {
         ...
         * @return
         */
        void queryPayment(String userid,String custom_code, int status,String keyword,String startTime,String endTime,int page);
        /**
         * 回款查询
         * @param page 页码
         * @return
         */
        void queryPayment(String userid,String custom_code, int status,String keyword,int type,int page);
        /**
         * 删除回款
