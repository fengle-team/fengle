...
import com.yunqi.fengle.presenter.contract.NewContactsContract;
...
public class NewContactsPresenter extends RxPresenter<NewContactsContract.View> implements NewContactsContract.Presenter {

    private RetrofitHelper mRetrofitHelper;

    @Inject
    public NewContactsPresenter(RetrofitHelper retrofitHelper) {
    ...
    @Override
    public void addLinkman(AddLinkmanRequest request, final ResponseListener listener) {
        Subscription rxSubscription = mRetrofitHelper.addLinkman(request)
                ...
                .subscribe(new BaseSubscriber(mView) {
                    ...
                    protected void onFailure(int errorCode, String msg) {
                        listener.onFaild(new NetResponse(-1,msg));
                    }
                });
        addSubscrebe(rxSubscription);
    }
