...
import com.yunqi.fengle.presenter.AddDeliveryPresenter;
 ...
 * 添加发货申请
 */
public class AddDeliveryRequestActivity extends BaseActivity<AddDeliveryPresenter> implements AddDeliveryContract.View {
    ...
    private void setWidgetListener() {
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if(goodsArray.size()>0){
                            DialogHelper.showDialog(AddDeliveryRequestActivity.this, getString(R.string.warimg_selected_goods_clear), new SimpleDialogFragment.OnSimpleDialogListener() {
                                @Override
                                public void onOk() {
                                    goodsArray.clear();
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if(selectCustomer==null){
                            ToastUtil.showNoticeToast(AddDeliveryRequestActivity.this,getString(R.string.warimg_unselect_customer));
                            return;
                        }
        ...
        tableView.addDataClickListener(new TableDataClickListener<GoodsAndWarehouse>() {
            ...
            public void onDataClicked(final int rowIndex, GoodsAndWarehouse goodsAndWarehouse) {
                DialogHelper.showDialog(AddDeliveryRequestActivity.this, "确定删除?", new SimpleDialogFragment.OnSimpleDialogListener() {
                    @Override
                    public void onOk() {
    ...
    private void addBill() {
        ...
        if (goodsArray.isEmpty()) {
            ToastUtil.showNoticeToast(AddDeliveryRequestActivity.this,getString(R.string.warimg_unselect_goods));
            return;
        }
