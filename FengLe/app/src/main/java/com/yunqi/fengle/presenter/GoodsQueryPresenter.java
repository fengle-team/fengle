...
public class GoodsQueryPresenter extends RxPresenter<GoodsQueryContract.View> implements GoodsQueryContract.Presenter {
    ...
    @Override
    public void queryGoods(String area_code,String keyword, String custom_code, String user_code,  String warehouse_code,final int page,boolean isPromotion,boolean isPlanAdjustment) {
        Subscription rxSubscription = mRetrofitHelper.queryGoods(area_code,keyword,custom_code,user_code,warehouse_code,page,isPromotion,isPlanAdjustment)
