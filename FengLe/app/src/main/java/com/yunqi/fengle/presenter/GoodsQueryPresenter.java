...
public class GoodsQueryPresenter extends RxPresenter<GoodsQueryContract.View> implements GoodsQueryContract.Presenter {
    ...
    @Override
    public void queryGoods(String keyword, String custom_code, String user_code,  String warehouse_code,final int page) {
        Subscription rxSubscription = mRetrofitHelper.queryGoods(keyword,custom_code,user_code,warehouse_code,page)
